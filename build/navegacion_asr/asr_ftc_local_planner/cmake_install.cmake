# Install script for directory: /home/jtpau/TFM/src/navegacion_asr/asr_ftc_local_planner
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/pkgconfig" TYPE FILE FILES "/home/jtpau/TFM/build/navegacion_asr/asr_ftc_local_planner/catkin_generated/installspace/asr_ftc_local_planner.pc")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/asr_ftc_local_planner/cmake" TYPE FILE FILES
    "/home/jtpau/TFM/build/navegacion_asr/asr_ftc_local_planner/catkin_generated/installspace/asr_ftc_local_plannerConfig.cmake"
    "/home/jtpau/TFM/build/navegacion_asr/asr_ftc_local_planner/catkin_generated/installspace/asr_ftc_local_plannerConfig-version.cmake"
    )
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/asr_ftc_local_planner" TYPE FILE FILES "/home/jtpau/TFM/src/navegacion_asr/asr_ftc_local_planner/package.xml")
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/asr_ftc_local_planner" TYPE FILE FILES "/home/jtpau/TFM/src/navegacion_asr/asr_ftc_local_planner/blp_plugin.xml")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/include/asr_ftc_local_planner" TYPE DIRECTORY FILES "/home/jtpau/TFM/src/navegacion_asr/asr_ftc_local_planner/include/asr_ftc_local_planner/" REGEX "/\\.svn$" EXCLUDE)
endif()
