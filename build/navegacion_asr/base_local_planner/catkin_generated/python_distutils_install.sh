...
echo_and_run cd "/home/jtpau/TFM/src/navegacion_asr/base_local_planner"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jtpau/TFM/src/navegacion_asr/base_local_planner/setup.py" \
     \
    build --build-base "/home/jtpau/TFM/build/navegacion_asr/base_local_planner" \
    install \
    --root="${DESTDIR-/}" \
