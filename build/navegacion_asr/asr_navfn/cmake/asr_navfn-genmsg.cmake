...
get_filename_component(_filename "/home/jtpau/TFM/src/navegacion_asr/asr_navfn/srv/MakeNavPlan.srv" NAME_WE)
add_custom_target(_asr_navfn_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "asr_navfn" "/home/jtpau/TFM/src/navegacion_asr/asr_navfn/srv/MakeNavPlan.srv" "std_msgs/Header:geometry_msgs/Pose:geometry_msgs/Point:geometry_msgs/Quaternion:geometry_msgs/PoseStamped"
)

get_filename_component(_filename "/home/jtpau/TFM/src/navegacion_asr/asr_navfn/srv/SetCostmap.srv" NAME_WE)
add_custom_target(_asr_navfn_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "asr_navfn" "/home/jtpau/TFM/src/navegacion_asr/asr_navfn/srv/SetCostmap.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/asr_navfn)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/asr_navfn\")")
  # install generated code
  install(
