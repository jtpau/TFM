...
echo_and_run cd "/home/jtpau/TFM/src/spencer_people_tracking/utils/spencer_diagnostics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jtpau/TFM/src/spencer_people_tracking/utils/spencer_diagnostics/setup.py" \
     \
    build --build-base "/home/jtpau/TFM/build/spencer_people_tracking/utils/spencer_diagnostics" \
    install \
    --root="${DESTDIR-/}" \
