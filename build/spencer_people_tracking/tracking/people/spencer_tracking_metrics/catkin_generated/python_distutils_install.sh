...
echo_and_run cd "/home/jtpau/TFM/src/spencer_people_tracking/tracking/people/spencer_tracking_metrics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jtpau/TFM/src/spencer_people_tracking/tracking/people/spencer_tracking_metrics/setup.py" \
     \
    build --build-base "/home/jtpau/TFM/build/spencer_people_tracking/tracking/people/spencer_tracking_metrics" \
    install \
    --root="${DESTDIR-/}" \
