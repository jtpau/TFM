...
if("TRUE" STREQUAL "TRUE")
  set(srl_laser_features_SOURCE_PREFIX /home/jtpau/TFM/src/spencer_people_tracking/detection/laser_detectors/srl_laser_features)
  set(srl_laser_features_DEVEL_PREFIX /home/jtpau/TFM/devel)
  ...
  set(srl_laser_features_INSTALL_PREFIX /home/jtpau/TFM/install)
...
if(NOT "/home/jtpau/TFM/src/spencer_people_tracking/detection/laser_detectors/srl_laser_features/include " STREQUAL " ")
  set(srl_laser_features_INCLUDE_DIRS "")
  set(_include_dirs "/home/jtpau/TFM/src/spencer_people_tracking/detection/laser_detectors/srl_laser_features/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'srl_laser_features' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jtpau/TFM/src/spencer_people_tracking/detection/laser_detectors/srl_laser_features/${idir}'.  ${_report}")
    endif()
