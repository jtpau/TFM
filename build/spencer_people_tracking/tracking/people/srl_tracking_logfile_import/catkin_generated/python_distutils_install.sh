...
echo_and_run cd "/home/jtpau/TFM/src/spencer_people_tracking/tracking/people/srl_tracking_logfile_import"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jtpau/TFM/src/spencer_people_tracking/tracking/people/srl_tracking_logfile_import/setup.py" \
     \
    build --build-base "/home/jtpau/TFM/build/spencer_people_tracking/tracking/people/srl_tracking_logfile_import" \
    install \
    --root="${DESTDIR-/}" \
